...
def attempt_download(weights):
    try:
        ...
        # Ensure 'assets' key exists before accessing it
        if 'assets' in response:
            assets = [x['name'] for x in response['assets']]  # Extract asset names
    ...
    # Add further logic here based on assets and tag
    print(f"Assets: {assets}, Tag: {tag}")
